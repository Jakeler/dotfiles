function fish_prompt --description 'Informative prompt with VCS, exit status and time'
    ...
    # Date
    set -l colored_date (set_color white --bold)(date +%X)$normal
    
    # Host
    set -l colored_host (set_color $fish_color_host)(prompt_hostname)$normal
    ...
    set -l colored_pwd (set_color $color_cwd)(prompt_pwd)$normal

    # VCS
    set -l colored_vcs (printf "%s" (fish_vcs_prompt))
